...
class EducationInstitutionsLandingPage extends StatefulWidget {
  const EducationInstitutionsLandingPage({super.key});

  @override
  State<EducationInstitutionsLandingPage> createState() =>
      _EducationInstitutionsLandingPageState();
}

class _EducationInstitutionsLandingPageState
    extends State<EducationInstitutionsLandingPage>
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          _buildBlockchainSection(isMobile, isTablet),
  ...
  Widget _buildBlockchainSection(bool isMobile, bool isTablet) {
    return Container(
      width: double.infinity,
      color: const Color(0xFFF8F9FA),
      padding: EdgeInsets.symmetric(
      ...
      child: Container(
        constraints: const BoxConstraints(maxWidth: 1200),
        child: isMobile
            ? _buildMobileBlockchainLayout()
            : _buildDesktopBlockchainLayout(isTablet),
      ),
    );
  }

  Widget _buildMobileBlockchainLayout() {
    return Column(
      children: [
        _buildBlockchainContent(isMobile: true),
        const SizedBox(height: 40),
        _buildBlockchainVisual(isMobile: true),
      ],
    );
  }

  Widget _buildDesktopBlockchainLayout(bool isTablet) {
    return Row(
      children: [
        Expanded(
          flex: 5,
          child: _buildBlockchainVisual(isMobile: false),
        ),
        const SizedBox(width: 60),
        Expanded(
          flex: 5,
          child: _buildBlockchainContent(isMobile: false),
        ),
      ],
    );
  }

  Widget _buildBlockchainContent({required bool isMobile}) {
    return Column(
      crossAxisAlignment:
          isMobile ? CrossAxisAlignment.center : CrossAxisAlignment.start,
      children: [
        ...
        _buildBlockchainBenefits(isMobile),
      ],
    );
  }
  ...
  Widget _buildBlockchainVisual({required bool isMobile}) {
    return Container(
        ...
        child: Column(
          children: [
            _buildSectionHeader(
              ...
              'See what our partners say about transforming their credential management',
              isMobile,
            ),
            const SizedBox(height: 60),
  ...
  Widget _buildTestimonialCards(bool isMobile, bool isTablet) {
    final testimonials = [
      TestimonialData(
        quote:
            'SolidCV has revolutionized how we issue and manage certificates. Our graduates love the instant verification feature.',
        author: 'Dr. Sarah Johnson',
        position: 'Dean of Academic Affairs',
        institution: 'MIT Business School',
      ),
      TestimonialData(
        quote:
            'The blockchain technology gives our credentials unmatched credibility. Employers trust our certificates completely.',
      ...
      TestimonialData(
        quote:
            'We\'ve reduced our administrative costs by 65% while improving the security and reliability of our credentials.',
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 20),
            Text(
              'Join the future of education today. Start issuing blockchain-verified credentials and provide your students with AI-powered career guidance.',
              style: GoogleFonts.inter(
                fontSize: isMobile ? 16 : 18,
                color: Colors.white.withOpacity(0.9),
                height: 1.6,
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 20),
            Text(
              'Empowering educational institutions with blockchain-verified credentials and AI-powered career guidance.',
              style: GoogleFonts.inter(
                fontSize: 16,
