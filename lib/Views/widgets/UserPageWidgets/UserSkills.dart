...
class UserSkillsWidget extends StatefulWidget {
  final String userId;

  const UserSkillsWidget({Key? key, required this.userId}) : super(key: key);

  @override
  _UserSkillsWidgetState createState() => _UserSkillsWidgetState();
}

class _UserSkillsWidgetState extends State<UserSkillsWidget> {
